	...
	<div class="cw1200">
		...
		<div style="position:absolute;right:30px;bottom:240px;margin-right:20px;">
			<ul class="pagination pagination-lg">
				<li><a
						href="${pageContext.request.contextPath}/area/requestArea?id=${areaId}&page=${pageInfo.prePage}">&laquo;</a></li>
				<c:forEach var="i" begin="1" end="${pageInfo.pages}"
					...
					<c:choose>
						<c:when test="${pageUtils.currentPageNum==i}">
							<li class="active"><a
									href="${pageContext.request.contextPath}/area/requestArea?id=${areaId}&page=${status.index}">${status.index}</a></li>
						</c:when>
						<c:otherwise>
				...
				<li><a
						href="${pageContext.request.contextPath}/area/requestArea?id=${areaId}&page=${pageInfo.nextPage}">&raquo;</a></li>
			</ul>
		</div>
